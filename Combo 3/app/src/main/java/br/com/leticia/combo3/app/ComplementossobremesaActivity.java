...
public class ComplementossobremesaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.complementossobremesa);
        ...
        btnConcluir.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                //---------------
                // configurando alerta
                AlertDialog.Builder builder = new AlertDialog.Builder(ComplementossobremesaActivity.this);
